...
void main() {
  group('Theme Mode Tests', () {
    testWidgets('should correctly display light theme', (WidgetTester tester) async {
                ...
                children: [
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Text('Card Content', style: theme.textTheme.bodyMedium),
                    ),
                  ),
                ],
              ),
    ...
    testWidgets('should correctly display dark theme', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
    ...
    testWidgets('should switch between themes smoothly', (WidgetTester tester) async {
